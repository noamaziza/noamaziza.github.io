...
function victoiresPossibles(pions, joueurs, tour)
{
     ...
     for (var i = 0, len = pions.length; i < len; i++)
     {
         pions[i].addEventListener("click", function()
         {
              ...
              else
              {
                  ...
                  jeuEstFini = victoiresPossibles(pions, joueurs, tour);

                  if(jeuEstFini)
                  {
                      afficheur.sendMessage("Le joueur " + joueurs[tour] + " a gagné ! <br /> <a href='../Html/morpion.html'>Rejouer</a>");
                      return;
                  }

                  if (matchNul(pions))
                  {
                      afficheur.sendMessage("Match Nul ! <br/> <a href='../Html/morpion.html'>Rejouer</a>");
                      return;
                  }
